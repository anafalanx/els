...
foreach {file init commands} {
    ...
    winfs.dll  Winfs   {::els::win_replace_file ::els::win_open_folder ::els::win_fsync ::els::win_drive_type ::els::win_meminfo ::els::win_virtual_screen ::els::win_worker_spawn_watch ::els::win_worker_watch ::els::win_worker_status ::els::win_worker_kill ::els::win_path_reparse}
