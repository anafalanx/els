 ...
 *
 * `elscap::window <hwnd>` renders a specific window with PrintWindow
 * (PW_RENDERFULLCONTENT) into an off-screen DC — works even when the window is
 * occluded or in the background, with no foreground/clipboard/Snipping-Tool
