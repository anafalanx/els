...
Tcl_Channel
Tcl_OpenTcpServerEx(interp, service, myaddr, flags, backlog, proc, clientData)
```
...
ORed combination of **TCL_TCPSERVER_*** flags that specify additional information about the socket being created.
