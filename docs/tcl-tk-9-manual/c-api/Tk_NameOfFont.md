...
The procedure **Tk_FontGetDescription** returns information about the font description as a Tcl list. One possible result is “{{DejaVu Sans} -16 bold underline}”.
