...
- **`-weight`** — database name `weight`, class `Weight`
...
In addition to the standard **cget**, **configure**, **instate**, **state** and **style** commands (see **ttk::widget**), panedwindow widgets support the following additional commands:
