...
- **`-indicatoron`** — database name `indicatorOn`, class `IndicatorOn`
...
- **`-offrelief`** — database name `offRelief`, class `OffRelief`
...
- **`-selectimage`** — database name `selectImage`, class `SelectImage`
...
- **`-tristateimage`** — database name `tristateImage`, class `TristateImage`
...
- **`-tristatevalue`** — database name `tristateValue`, class `Value`
