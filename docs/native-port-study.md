...
>   project"). els now builds against z's **shared runtime under `<z>/r`**
>   (`z tasks env` prints the roots — currently `C:\z\r`): Tcl/Tk 9 + the static
...
>   `C:/Users/anafa/dev/els/…`, read the corresponding `<z>/r/…` payload.
